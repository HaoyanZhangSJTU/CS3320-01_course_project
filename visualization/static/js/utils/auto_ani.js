...
export function auto_ani($wrap) {
    ...
    (function () {
        var plain, i;
        for (i = 0; i < 10; i++) {
            plain = new THREE.Mesh(new THREE.PlaneGeometry(length * 2 + 1, radius * 3, 1), new THREE.MeshBasicMaterial({ color: 0x00000, transparent: true, opacity: 0.13 }));
    ...
    renderer.setSize(canvassize*0.7, canvassize);
